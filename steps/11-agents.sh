...
echo ""
echo -e "  ${BCYAN}╭─────────────────────────────────────────────────────────────────╮${NC}"
echo -e "  ${BCYAN}│${NC}  ${BOLD}Coding Agents${NC}  — toggle with number, Enter to confirm         ${BCYAN}│${NC}"
echo -e "  ${BCYAN}├─────────────────────────────────────────────────────────────────┤${NC}"
...
echo -e "  ${BCYAN}├─────────────────────────────────────────────────────────────────┤${NC}"
echo -e "  ${BCYAN}│${NC}  ${DIM}Enter numbers to toggle (e.g. 12 = Qwen+Codex). Default = 12${NC}  ${BCYAN}│${NC}"
echo -e "  ${BCYAN}│${NC}  ${DIM}Already-installed tools are skipped automatically.${NC}            ${BCYAN}│${NC}"
echo -e "  ${BCYAN}╰─────────────────────────────────────────────────────────────────╯${NC}"
echo ""
...
if [[ "$_do_qwen" == "true" ]]; then
  ...
  if [[ "$_do_qwen" == "true" ]]; then
    ...
    echo ""
    echo -e "  ${BCYAN}╭──────────────────────────────────────────────────────────╮${NC}"
    echo -e "  ${BCYAN}│${NC}  ${BOLD}Qwen Code — Auth mode${NC}                                    ${BCYAN}│${NC}"
    echo -e "  ${BCYAN}├──────────────────────────────────────────────────────────┤${NC}"
    echo -e "  ${BCYAN}│${NC}  ${CYAN}[1]${NC}  ${BOLD}Qwen OAuth${NC}  ${DIM}(recommended)${NC}                           ${BCYAN}│${NC}"
    echo -e "  ${BCYAN}│${NC}       ${DIM}Free · 1000 req/day · browser sign-in once${NC}           ${BCYAN}│${NC}"
    echo -e "  ${BCYAN}│${NC}                                                          ${BCYAN}│${NC}"
    echo -e "  ${BCYAN}│${NC}  ${CYAN}[2]${NC}  ${BOLD}Local only${NC}  ${DIM}(100% offline)${NC}                          ${BCYAN}│${NC}"
