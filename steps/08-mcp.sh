...
if [[ -t 0 ]]; then
  echo ""
  echo -e "  ${BCYAN}╭──────────────────────────────────────────────────────────╮${NC}"
  echo -e "  ${BCYAN}│${NC}  ${BOLD}MCP Tool Bridges${NC}  ${DIM}(optional)${NC}                          ${BCYAN}│${NC}"
  echo -e "  ${BCYAN}├──────────────────────────────────────────────────────────┤${NC}"
  echo -e "  ${BCYAN}│${NC}  Lets AI models call real tools during chat:            ${BCYAN}│${NC}"
  echo -e "  ${BCYAN}│${NC}  ${CYAN}·${NC}  ${BOLD}time${NC}        ${DIM}current date/time, timezone  (:8010)${NC}    ${BCYAN}│${NC}"
  echo -e "  ${BCYAN}│${NC}  ${CYAN}·${NC}  ${BOLD}filesystem${NC}  ${DIM}read/write files in ~/         (:8011)${NC}    ${BCYAN}│${NC}"
  echo -e "  ${BCYAN}│${NC}                                                          ${BCYAN}│${NC}"
  echo -e "  ${BCYAN}│${NC}  ${DIM}~5 MB install · install later: llm-mcp-start${NC}           ${BCYAN}│${NC}"
  echo -e "  ${BCYAN}╰──────────────────────────────────────────────────────────╯${NC}"
  echo ""
